        ...
        <Sider theme={'light'} collapsible collapsed={collapsed} onCollapse={onCollapse}>
          ...
          <Menu 
            ...
            mode="inline">
                    ...
                    <Menu.Item key={ROUTERS.INTERNS_MANAGER} icon={<FaSchool />}>
                            Quản lý Thực tập sinh
                    </Menu.Item>
                    <Menu.Item key={ROUTERS.INFORMATION} icon={<FaBuilding />}>
                            Quản lý Khóa học
                    </Menu.Item>
                    <Menu.Item key={ROUTERS.INFORMATION} icon={<FaBuilding />}>
                            Quản lý Bài học
                    </Menu.Item>
                    <Menu.Item key={ROUTERS.INFORMATION} icon={<FaRegChartBar />}>
                            Quản lý Câu hỏi
                    </Menu.Item>
          </Menu>
        </Sider>
